...
#' head(nps_gaged)
#' }
anlz_nps_gaged <- function(yrrng = c('2021-01-01', '2023-12-31'), mancopth = NULL, pincopth = NULL, lakemanpth, tampabypth, bellshlpth, allflo = NULL, verbose = TRUE){
  ...
  if(is.null(allflo)){
    ...
    allflo <- util_nps_getflow(lakemanpth, tampabypth, bellshlpth, yrrng = floyrrng, verbose = verbose)
  }
