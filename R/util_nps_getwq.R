...
#'
#' @details If \code{mancopth} or \code{pincopth} are \code{NULL}, Manatee and Pinellas County data are retrieved from the FDEP WIN database using \code{\link[tbeptools]{read_importwqwin}}.  Hillsborough County data is retrieved using \code{\link[tbeptools]{read_importwq}}. If \code{mancopth} or \code{pincopth} are not \code{NULL}, then data are imported from disk using the path specified. Data from the Environmental Protection Commission (EPC) of Hillsborough County are imported using \href{https://tbep-tech.github.io/tbeptools/reference/read_importepc.html}{\code{read_importepc}} from the tbeptools R package.
#'
