...
* `util_nps_getusgsflow()`: Gets USGS flow data for NPS calculations, used in `util_nps_getflow()`. A preprocessed USGS flow data frame can be provided using the `usgsflow` argument to avoid re-downloading the data.
