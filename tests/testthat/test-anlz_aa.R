...
test_that("load_tons differs from eff_load_tons for NPS when normalization ratio != 1", {
  # Use a large tn so CLEARWATER's entity load exceeds its corrections (~7.5 tons).
  # Set hy_load to double mean_h2o_9294 so normalized load is half the corrected load.
  nps_wet <- nps_206_1(tn = 5000.0)
  nps_wet$hy_load <- nps_wet$hy_load * 2
  result <- anlz_aa(2023L, make_dps_empty(), make_ips_empty(), make_ml_empty(), nps_wet, tbbase)
...
test_that("load_tons equals eff_load_tons for DPS (no normalization)", {
  result <- anlz_aa(2023L, dps_bradenton_sw(), make_ips_empty(), make_ml_empty(), make_nps_empty(), tbbase)
...
test_that("loads outside yrrng do not contribute to the average eff_load_tons", {
  ...
  result_2022 <- anlz_aa(2022L, make_dps_empty(), make_ips_empty(), make_ml_empty(), nps_two, tbbase)
  result_both <- anlz_aa(c(2022, 2023), make_dps_empty(), make_ips_empty(), make_ml_empty(), nps_two, tbbase)
...
test_that("IPS rows all carry source equal to IPS", {
  result <- anlz_aa(2020L, make_dps_empty(), ips, make_ml_empty(), make_nps_empty(), tbbase)
...
test_that("DPS year range filtering averages only over yrrng years", {
  ...
  result_2022 <- anlz_aa(2022L,  dps_two, make_ips_empty(), make_ml_empty(), make_nps_empty(), tbbase)
  result_both <- anlz_aa(c(2022, 2023),  dps_two, make_ips_empty(), make_ml_empty(), make_nps_empty(), tbbase)
