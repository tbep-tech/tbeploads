...
This outlines how to propose a change to tbeploads. For a detailed
discussion on contributing to this package, please see the [development
contributing guide](https://rstd.io/tidy-contrib) and general [code
...
issue and make sure someone from TBEP agrees that it’s needed. If you’ve
...
help you write a unit test, if needed). See the general guide on [how to
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tbep-tech/tbeploads", fork = TRUE)`.
...
Please note that the tbeploads project is released with a [Contributor
Code of
Conduct](https://tbep-tech.github.io/tbeploads/CODE_OF_CONDUCT.md). By
